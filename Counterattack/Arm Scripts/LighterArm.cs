...
public class LighterArm : ArmStats
{
    ...
    void Start()
    {
        ...
        bulletCount = 1;
        bulletPrefab = Resources.Load("Sprites/Items/LighterBullet") as GameObject;
        firerate = 0.1f;
    ...
    public IEnumerator Attack()
    {
        ...
        for (int i = 0; i < bulletCount + bonusBulletCount; i++)
        {
            ...
            bullet.GetComponent<BulletHandler>().burnDamage = burn + bonusBurn;
